    ...
    <div class="container-fluid">
        <x-adminlte-card>
            <form method="POST">
                <div class="row">
                    <div class="col-12">
                        <x-adminlte-input name="title" label="Blog Başlık" placeholder="Blog Başlığı Giriniz." />
                    </div>
                </div>

                <div class="row">
                    <div class="col-12">
                        <label for="blogresimkapak">Blog Kapak Görseli</label>
                        <x-adminlte-input-file name="blogresimkapak"  placeholder="Blog Kapak Resmi Seçiniz.">

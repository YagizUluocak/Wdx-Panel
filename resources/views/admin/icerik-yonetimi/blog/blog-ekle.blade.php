    ...
    <div class="container-fluid">
        <x-adminlte-card>
            ...
            <form id="blogForm" method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        <x-adminlte-input name="baslik" label="Blog Başlık" placeholder="Blog Başlığı Giriniz." />
                    </div>
                </div>

                <div class="row">
                    <div class="col-12">
                        <label for="resim">Blog Kapak Görseli</label>
                        <x-adminlte-input-file name="resim"  placeholder="Blog Kapak Resmi Seçiniz.">
